...
export function SearchDetail(){
  const News:{}[] = useSelector((prev: any)=> prev.search.value)
  const NewsId:any = useParams()
  const item:any = News[NewsId.id]
  return(
    <>
      <section className="w-11/12 mx-auto py-12">
      <Link to='/search' className="md:text-xl font-thin flex gap-2"><span className="my-auto"><VscChevronLeft/></span><span className="">Back</span></Link>
      <div className="py-6">
