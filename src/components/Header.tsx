...
export default function Header(){
  ...
  return(
    ...
    <header className="relative flex w-full justify-between border py-5 px-6">
        <Link to='/' className='font-bold text-4xl'>News<span className='text-blue-500 '>X0</span></Link>
        ...
        <div className={`${search ? 'block' : 'hidden'} absolute h-[100vh] color z-50 w-full top-0 left-0`}>
